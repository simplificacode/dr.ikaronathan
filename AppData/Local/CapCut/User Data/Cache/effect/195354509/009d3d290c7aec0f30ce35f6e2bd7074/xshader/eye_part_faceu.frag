...
void main(void)
{
    ...
    // gl_FragColor = vec4(sucai.rgb, 1); return;
    sucai *= clamp(intensity * opacity, 0.0, 1.0);
    float nonZeroSucaiAlpha = max(0.0001, sucai.a);
    ...
    float nonZeroReflectAlpha = max(0.0001, reflect.a);
