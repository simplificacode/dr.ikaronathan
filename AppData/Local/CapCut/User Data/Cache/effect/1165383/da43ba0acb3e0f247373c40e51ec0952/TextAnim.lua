...
function TextAnim:initAnim()
    if self.tween == nil then
        ...
        self.tween = self.text.entity.scene.tween:fromTo(self.materials:get(0), {["eraseUV"] = Amaz.Vector2f(0, 1)}, {["eraseUV"] = Amaz.Vector2f(0, 0)}, 0.1, Amaz.Ease.linear, nil, 0.0, nil, false)
