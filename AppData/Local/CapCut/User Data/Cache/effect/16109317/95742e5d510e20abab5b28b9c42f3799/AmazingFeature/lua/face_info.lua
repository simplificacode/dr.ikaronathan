...
function face_info:onStart(comp, script)
    ...
    Amaz.LOGW(self.logTag, "lydebug start")
...
function face_info:onUpdate(comp, deltaTime)
    Amaz.LOGW(self.logTag, "lydebug onUpdate")
...
function face_info:updateFaceInfoBySize()
    ...
    Amaz.LOGW(self.logTag, "lydebug updateFaceInfoBySize faceCount " .. faceCount .. " freidCount " .. freidCount)
    for i = 0, self.maxFaceNum - 1 do
        ...
        Amaz.LOGW(self.logTag, "lydebug updateFaceInfoBySize add face info index " .. i .. " id " .. trackId .. " size " .. faceSize)
    end
...
function face_info:updateFaceAlgoParams()
    ...
    Amaz.LOGW(self.logTag, "lydebug updateFaceAlgoParams face algo params size " .. faceAlgoParams:size())
end
